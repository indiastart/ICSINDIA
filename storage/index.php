...
//constants 1
define("PROJECT", "ICS DB Application");
...
if(!$auth->isAuthorized()) //user is not authorized - display the login screen
{
	...
	echo "<span style='font-size:11px;'>".$lang['powered']." <a href='".PROJECT_URL."' target='_blank' style='font-size:11px;'><img style='max-height:25px;'' src='/img/logo-color hd.png'></img>".PROJECT."</a> | "; 
...
else //user is authorized - display the main application
{
	...
	echo "<div id='leftNav'>";
	echo "<h1><a href='".PAGE."'>";
	echo "<span id='logo'><img  style='max-height:45px' src='img/logo-color hd.png'></img></span><br> <span id='version'>".PROJECT."<br>v".VERSION."</span>";
	echo "</a></h1>";
	...
	echo "<br/>";
	echo "<span style='font-size:11px;'>".$lang['powered']." <a href='".PROJECT_URL."' target='_blank' style='font-size:11px;'><img style='max-height:20px;'' src='img/logo-color hd.png'></img>".PROJECT."</a> | ";
	printf($lang['page_gen'], $pageTimer);
	echo "</span>";
	echo "</td></tr></table>";
